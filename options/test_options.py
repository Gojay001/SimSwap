...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--which_epoch', type=str, default='780000', help='which epoch to load? set to latest to use latest cached model')
        ...
        self.parser.add_argument("--pic_a_path", type=str, default='/cephFS/gaojie/data/stylegan2/model/12.png', help="Person who provides identity information")
        self.parser.add_argument("--pic_b_path", type=str, default='/cephFS/gaojie/data/stylegan2/model/2179.png', help="Person who provides information other than their identity")
        ...
        self.parser.add_argument('--no_simswaplogo', action='store_true', default=True, help='Remove the watermark')
        self.parser.add_argument('--use_mask', action='store_true', help='Use mask for better result')
        self.parser.add_argument('--crop_size', type=int, default=256, help='Crop of size of input image')
